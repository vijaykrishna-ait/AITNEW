...
<section class="cta" id="contact">
  <h2>Curious how our values shape an engagement?</h2>
  <p>Talk to us about your project — and see these values in practice from day one.</p>
  <div class="actions">
    <a href="<?= $base ?>contact" class="btn btn-lime">Talk to Us</a>
    <a href="<?= $base ?>life-with-ait" class="btn btn-outline-light">Explore Life with AIT</a>
  </div>
</section>
