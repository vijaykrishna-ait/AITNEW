  ...
  <div class="wrap">
    ...
    <div class="its-services-grid">
      <div class="its-service-card">
        ...
        <p>Seamlessly connect Angular applications to backend APIs using HttpClient, RxJS, and interceptors for reliable data exchange.</p>
        <div class="its-tech-tags"><span>HttpClient</span><span>RxJS</span><span>REST</span></div>
      </div>
      <div class="its-service-card">
        <h3>Performance Optimization</h3>
        <p>Optimize Angular application performance with lazy loading, change detection strategies, and bundle optimization techniques.</p>
        <div class="its-tech-tags"><span>Lazy Loading</span><span>OnPush</span><span>Tree Shaking</span></div>
      </div>
      <div class="its-service-card">
        <h3>E-Shops & Marketplaces</h3>
        <p>Build feature-rich Angular-powered e-commerce platforms with shopping carts, product catalogs, and payment gateway integrations.</p>
        <div class="its-tech-tags"><span>PWA</span><span>NgRx</span><span>Material</span></div>
      </div>
      <div class="its-service-card">
        <h3>Component-Based Architecture</h3>
        <p>Develop scalable Angular applications using well-structured component hierarchies, shared modules, and reusable service layers.</p>
        <div class="its-tech-tags"><span>Components</span><span>Modules</span><span>Services</span></div>
      </div>
      <div class="its-service-card">
        <h3>Angular Material UI</h3>
        <p>Implement Google's Material Design with Angular Material components — accessible, polished and production-ready UIs.</p>
        <div class="its-tech-tags"><span>Angular Material</span><span>CDK</span><span>Theming</span></div>
      </div>
      <div class="its-service-card">
        <h3>State Management with NgRx</h3>
        <p>Implement reactive state management using NgRx Store and Effects for predictable, testable Angular applications at scale.</p>
        <div class="its-tech-tags"><span>NgRx</span><span>Store</span><span>Effects</span></div>
      </div>
    </div>
  </div>
</section>
