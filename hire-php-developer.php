...
<section class="its-hero">
  <div class="wrap">
    ...
    <p class="lead">At Adhiran, we develop your thoughts through the versatility of the PHP programming language. Over
...
<section>
  <div class="wrap its-intro-grid">
    <div class="its-intro-content">
      ...
      <p>Our style is very open, where clients are always involved in the decision-making process. We value your
        participation and maintain your engagement throughout the process from the time we develop an idea up to its
        implementation.</p>
      <p>Focused on innovation and quality, we are ready to make the necessary efforts to provide best PHP solutions
  ...
  <div class="wrap">
    ...
    <div class="its-services-grid">
      <div class="its-service-card">
        ...
        <p>Build elegant, expressive PHP applications with Laravel — the most popular PHP framework for modern web
          development.</p>
        <div class="its-tech-tags"><span>Laravel</span><span>Eloquent</span><span>Blade</span></div>
      </div>
      <div class="its-service-card">
        <h3>Content Management Systems (CMS)</h3>
        <p>Develop custom CMS solutions and plugins for WordPress, Drupal, and Joomla — scalable and easy to manage.</p>
        <div class="its-tech-tags"><span>WordPress</span><span>Drupal</span><span>Joomla</span></div>
      </div>
      <div class="its-service-card">
        <h3>Integrated API Development</h3>
        <p>Design and build robust REST and GraphQL APIs with PHP — well-documented, versioned, and secured with OAuth
          2.0.</p>
        <div class="its-tech-tags"><span>REST API</span><span>GraphQL</span><span>OAuth</span></div>
      </div>
      <div class="its-service-card">
        <h3>E-commerce Development</h3>
        <p>Build high-converting online stores with WooCommerce, Magento, and custom PHP e-commerce platforms.</p>
        <div class="its-tech-tags"><span>WooCommerce</span><span>Magento</span><span>OpenCart</span></div>
      </div>
      <div class="its-service-card">
        <h3>CodeIgniter Development</h3>
        <p>Lightweight, fast PHP applications with CodeIgniter's clean MVC architecture — rapid development with minimal
          configuration.</p>
        <div class="its-tech-tags"><span>CodeIgniter</span><span>MVC</span><span>PHP 8</span></div>
      </div>
      <div class="its-service-card">
        <h3>Symfony Framework Development</h3>
        <p>Enterprise-grade PHP applications with Symfony's component-based architecture — robust, flexible, and
          production-proven.</p>
        <div class="its-tech-tags"><span>Symfony</span><span>Doctrine</span><span>Twig</span></div>
      </div>
    </div>
  </div>
</section>
