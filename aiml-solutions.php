  ...
  <div class="wrap">
    ...
    <div class="itsol-adv-grid">
      <div class="itsol-adv-card">
        ...
        <p>AI systems that analyze vast datasets and surface the insights that matter, enabling faster and more accurate
          decision-making at every level.</p>
      </div>
      <div class="itsol-adv-card">
        <h4>Operational Efficiency</h4>
        <p>Automate repetitive cognitive tasks, optimize resource allocation, and streamline workflows to dramatically
          reduce operating costs.</p>
      </div>
      <div class="itsol-adv-card">
        <h4>Personalized Experiences</h4>
        <p>Deliver hyper-personalized customer experiences at scale — product recommendations, dynamic content, and
          adaptive interfaces.</p>
      </div>
      <div class="itsol-adv-card">
        <h4>Predictive Insights</h4>
        <p>Anticipate future outcomes with predictive models — from demand forecasting and churn prediction to
          predictive maintenance and risk scoring.</p>
      </div>
      <div class="itsol-adv-card">
        <h4>Competitive Advantage</h4>
        <p>Organizations that embed AI into their core processes outperform competitors. We help you build that
          advantage systematically.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="itsol-why-grid">
      <div class="itsol-why-card">
        <div class="itsol-why-ico"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2.5">
            <polyline points="20 6 9 17 4 12" />
          </svg></div>
        <div>
          <h4>Proven AI Expertise</h4>
          <p>Our data scientists and ML engineers have delivered production AI systems across healthcare, finance,
            retail, and industrial domains.</p>
        </div>
      </div>
      <div class="itsol-why-card">
        <div class="itsol-why-ico"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <div>
          ...
          <p>No pre-packaged models — every AI solution is trained on your data and designed for your specific business
            context and objectives.</p>
        </div>
      </div>
      <div class="itsol-why-card">
        <div class="itsol-why-ico"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <div>
          ...
          <p>We leverage the latest in deep learning, transformer architectures, generative AI, and MLOps for
      ...
      <div class="itsol-why-card">
        ...
        <div>
          ...
          <p>AI models require monitoring, retraining, and refinement as data distributions shift. Our MLOps team keeps
            your models accurate.</p>
        </div>
      </div>
      <div class="itsol-why-card">
        <div class="itsol-why-ico"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <div>
          ...
          <p>We measure success by business outcomes — revenue lift, cost reduction, error rates — not just technical
            model metrics.</p>
        </div>
      </div>
    </div>
...
<section class="cta">
  <div class="wrap">
    ...
    <p>Partner with Adhiran Infotech to unlock the full potential of cutting-edge IT solutions tailored for your
      industry.</p>
    <div class="actions">
