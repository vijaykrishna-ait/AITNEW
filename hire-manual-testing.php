  ...
  <div class="wrap">
    ...
    <div class="its-services-grid">
      <div class="its-service-card">
        ...
        <p>Simultaneous learning, test design, and test execution without predefined test cases — discovering defects missed by scripted tests.</p>
        <div class="its-tech-tags"><span>Session-Based</span><span>Risk-Based</span><span>Heuristics</span></div>
      </div>
      <div class="its-service-card">
        <h3>Ad-Hoc Testing</h3>
        <p>Informal, unstructured testing without documentation or planning — quickly validating new features and catching obvious defects.</p>
        <div class="its-tech-tags"><span>Informal</span><span>Rapid</span><span>Feature Validation</span></div>
      </div>
      <div class="its-service-card">
        <h3>User Interface (UI) Testing</h3>
        <p>Manually validate that your application's interface matches design specifications, is accessible, and provides a great user experience.</p>
        <div class="its-tech-tags"><span>UX</span><span>Accessibility</span><span>WCAG</span></div>
      </div>
      <div class="its-service-card">
        <h3>Cross-Browser Testing</h3>
        <p>Manually test your application across Chrome, Firefox, Safari, Edge, and mobile browsers to ensure consistent behaviour and appearance.</p>
        <div class="its-tech-tags"><span>Chrome</span><span>Safari</span><span>Firefox</span><span>Edge</span></div>
      </div>
      <div class="its-service-card">
        <h3>Regression Testing</h3>
        <p>Systematically re-test existing functionality after changes to ensure new code hasn't introduced defects into previously working features.</p>
        <div class="its-tech-tags"><span>Test Cases</span><span>Checklists</span><span>Defect Tracking</span></div>
      </div>
      <div class="its-service-card">
        <h3>End-to-End Testing</h3>
        <p>Validate complete business workflows from user input to system output — ensuring all integrated components work together correctly.</p>
        <div class="its-tech-tags"><span>E2E</span><span>User Flows</span><span>Integration</span></div>
      </div>
    </div>
  </div>
</section>
