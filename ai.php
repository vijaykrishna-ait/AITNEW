...
<section class="skills">
  <div class="wrap">
    <div class="section-head center">
      ...
      <p>A sample of the kinds of AI use cases our teams design and deliver for clients in each sector.</p>
    </div>
    <div class="usecase-grid">
      <div class="usecase-card">
        <span class="tag">Healthcare &amp; Life Sciences</span>
        <h3>AI-assisted diagnostics &amp; clinical decision support</h3>
        <p>Computer vision and predictive models that help clinicians flag risks earlier and prioritize care.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Banking &amp; Financial Services</span>
        <h3>Intelligent recruitment &amp; document screening</h3>
        <p>Azure OpenAI-powered screening that matches candidates and documents to roles, cutting review time by 30–50%.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Retail &amp; E-commerce</span>
        <h3>Personalization &amp; demand forecasting</h3>
        <p>ML-driven recommendations and inventory forecasting that lift conversion and reduce stockouts.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Manufacturing</span>
        <h3>Predictive maintenance &amp; visual quality inspection</h3>
        <p>IoT + computer vision models that catch defects and predict equipment failure before downtime occurs.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">EdTech</span>
        <h3>AI-based personalized learning</h3>
        <p>Adaptive learning engines that tailor content paths to each learner, improving completion rates.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Logistics</span>
        <h3>Real-time fleet &amp; route optimization</h3>
        <p>AI-driven routing and tracking models that improve delivery times across large vehicle fleets.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Professional Services</span>
        <h3>Document intelligence &amp; contract analytics</h3>
        <p>NLP models that extract, summarize and flag risk across large volumes of contracts and reports.</p>
      </div>
      <div class="usecase-card">
        <span class="tag">Hospitality</span>
        <h3>AI-powered guest experience &amp; chat support</h3>
        <p>Conversational AI for bookings, concierge requests and 24/7 multilingual guest support.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="cta" id="contact">
  ...
  <div class="actions">
    ...
    <a href="<?= $base ?>hire-me" class="btn btn-outline-light">Hire AI/ML Developers</a>
  </div>
</section>
