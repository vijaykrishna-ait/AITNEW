...
<section class="its-hero">
  <div class="wrap">
    ...
    <p class="lead">At Adhiran we develop effective and highly customizable smart mobile applications using Ionic, a
...
<section>
  <div class="wrap its-intro-grid">
    <div class="its-intro-content">
      ...
      <p>Ionic is supported by our team given competence in the Ionic ecosystem including Angular, Capacitor, Stencil
        for the development of secure and scalable mobile applications.</p>
      <p>At Adhiran, we value cooperation, we involve our clients in every stage of the process as much as possible
        while achieving their goals. We leverage the state of art innovation and tooling in mobile technology to deliver
        powerful Ionic applications.</p>
    </div>
    <div class="its-intro-img">
      <img src="<?= $base ?>img/it_staffing/ionic/ionic_desc.png"
        alt="Hire Expert Ionic Developers for Cross-Platform Mobile Apps">
    </div>
  </div>
</section>
...
<section class="solutions" id="services">
  <div class="wrap">
    <div class="section-head">
      ...
      <h2>Ionic Services</h2>
    </div>
    <div class="its-services-grid">
      <div class="its-service-card">
        <h3>Capacitor Integration for Native Features</h3>
        <p>Access native device APIs — camera, GPS, push notifications, biometrics — using Capacitor plugins in your
          Ionic application.</p>
        <div class="its-tech-tags"><span>Capacitor</span><span>Native APIs</span><span>Plugins</span></div>
      </div>
      <div class="its-service-card">
        <h3>Offline-First Mobile App Development</h3>
        <p>Build Ionic applications that work without internet connectivity using service workers, local storage, and
          sync strategies.</p>
        <div class="its-tech-tags"><span>Offline</span><span>Service Workers</span><span>SQLite</span></div>
      </div>
      <div class="its-service-card">
        <h3>Ionic-Powered Progressive Web Apps (PWAs)</h3>
        <p>Convert Ionic applications into installable Progressive Web Apps with offline support, push notifications,
          and app-like experiences.</p>
        <div class="its-tech-tags"><span>PWA</span><span>Service Workers</span><span>Web App Manifest</span></div>
      </div>
      <div class="its-service-card">
        <h3>Enterprise-Ready Secure Applications</h3>
        <p>Build secure Ionic enterprise apps with end-to-end encryption, biometric authentication, and certificate
          pinning.</p>
        <div class="its-tech-tags"><span>Security</span><span>Biometrics</span><span>MDM</span></div>
      </div>
      <div class="its-service-card">
        <h3>Ionic Angular Development</h3>
        <p>Combine the power of Ionic's UI components with Angular's enterprise-grade architecture for robust,
          maintainable apps.</p>
        <div class="its-tech-tags"><span>Ionic Angular</span><span>RxJS</span><span>NgRx</span></div>
      </div>
      <div class="its-service-card">
        <h3>Ionic React & Vue Development</h3>
        <p>Leverage Ionic's framework-agnostic component library with React or Vue.js for flexible cross-platform mobile
          development.</p>
        <div class="its-tech-tags"><span>Ionic React</span><span>Ionic Vue</span><span>Stencil</span></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="its-why-grid">
      <div class="its-why-card">
        ...
        <h4>Angular</h4>
        <p>A comprehensive front-end framework by Google that pairs naturally with Ionic for building large-scale,
