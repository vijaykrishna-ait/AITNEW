...
<section class="solutions" id="services">
  <div class="wrap">
    <div class="section-head">
      ...
      <h2>Our Java Services</h2>
    </div>
    <div class="its-services-grid">
      <div class="its-service-card">
        <h3>Microservices Development with Java</h3>
        <p>Design and build fine-grained, independently deployable Java microservices using Spring Boot and cloud-native patterns.</p>
        <div class="its-tech-tags"><span>Spring Boot</span><span>Docker</span><span>Kubernetes</span></div>
      </div>
      <div class="its-service-card">
        <h3>Cloud-Native Java Solutions</h3>
        <p>Develop cloud-native Java applications optimized for AWS, Azure, and GCP — containerized, scalable, and resilient.</p>
        <div class="its-tech-tags"><span>Spring Cloud</span><span>AWS</span><span>GCP</span></div>
      </div>
      <div class="its-service-card">
        <h3>Java-Based Big Data Solutions</h3>
        <p>Process large-scale datasets with Java using Apache Spark, Hadoop, and Kafka for real-time analytics and batch processing.</p>
        <div class="its-tech-tags"><span>Apache Spark</span><span>Hadoop</span><span>Kafka</span></div>
      </div>
      <div class="its-service-card">
        <h3>AI & Machine Learning with Java</h3>
        <p>Build AI-powered Java applications using DL4J, Weka, and integrations with Python ML models via APIs.</p>
        <div class="its-tech-tags"><span>DL4J</span><span>Weka</span><span>REST API</span></div>
      </div>
      <div class="its-service-card">
        <h3>Enterprise Application Development</h3>
        <p>Build mission-critical enterprise Java applications with Spring Framework — robust, secure, and highly maintainable at scale.</p>
        <div class="its-tech-tags"><span>Spring</span><span>JEE</span><span>Hibernate</span></div>
      </div>
      <div class="its-service-card">
        <h3>REST API Development</h3>
        <p>Design and implement RESTful and GraphQL APIs with Java Spring Boot for seamless backend service integration.</p>
        <div class="its-tech-tags"><span>Spring Boot</span><span>REST</span><span>OpenAPI</span></div>
      </div>
    </div>
  </div>
</section>
...
<section>
  <div class="wrap">
    ...
    <div class="its-why-grid">
      ...
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/struts.svg" alt=""></div>
        <h4>Struts</h4>
