    ...
    <style>
        ...
        * {
        ...
        .under-dev-hero {
            ...
            position: relative;
            overflow: hidden;
            background: linear-gradient(135deg, rgba(8, 17, 31, .96), rgba(16, 28, 48, .92)), url('https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1800&q=80') center/cover no-repeat;
        }
...
<body>
    <section class="under-dev-hero">
        <div class="wrap">
            <div class="content">
                <div class="icon"> <svg fill="none" viewBox="0 0 24 24" stroke-width="2">
                ...
                <p> We're working on something exciting. This page is currently being crafted by our team and will be
                    available soon. Thank you for your patience. </p>
                <div class="actions"> 
                    <a href="<?= $base ?>index" class="btn btn-primary">Back to Home</a> 
                    <a href="<?= $base ?>contact" class="btn btn-outline">Contact Us</a> </div>
            </div>
        </div>
    </section>
