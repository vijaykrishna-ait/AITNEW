...
<section class="its-hero">
  <div class="wrap">
    ...
    <p class="lead">Automation testing is imperative to give top-quality software quickly and with a lesser amount of
...
<section>
  <div class="wrap its-intro-grid">
    <div class="its-intro-content">
      ...
      <p>With our IT staff augmentation model, you can quickly hire dedicated automation testers with experience in your
        type of projects; you can concentrate on product development, and we will make sure that the resulting software
        is of high quality.</p>
      <p>Join our team to gain faster releases and the reliability of the product through full-featured automation
  ...
  <div class="wrap">
    ...
    <div class="its-services-grid">
      <div class="its-service-card">
        ...
        <p>Build comprehensive functional test suites that validate application behaviour across all key user flows and
          edge cases.</p>
        <div class="its-tech-tags"><span>Selenium</span><span>Cypress</span><span>Playwright</span></div>
      </div>
      <div class="its-service-card">
        <h3>API Testing</h3>
        <p>Automate REST, SOAP, and GraphQL API testing with Postman, REST Assured, and Karate — ensuring backend
          reliability at every release.</p>
        <div class="its-tech-tags"><span>Postman</span><span>REST Assured</span><span>Karate</span></div>
      </div>
      <div class="its-service-card">
        <h3>Regression Testing Automation</h3>
        <p>Create robust regression test suites that run on every commit, catching breaking changes before they reach
          production.</p>
        <div class="its-tech-tags"><span>CI/CD</span><span>Jenkins</span><span>GitHub Actions</span></div>
      </div>
      <div class="its-service-card">
        <h3>Performance and Load Testing</h3>
        <p>Simulate thousands of concurrent users with JMeter, Gatling, and k6 to identify bottlenecks before production
          go-live.</p>
        <div class="its-tech-tags"><span>JMeter</span><span>Gatling</span><span>k6</span></div>
      </div>
      <div class="its-service-card">
        <h3>Data-Driven Testing</h3>
        <p>Build data-driven test frameworks that validate application behaviour across multiple datasets and parameter
          combinations.</p>
        <div class="its-tech-tags"><span>TestNG</span><span>Parameterized</span><span>CSV Data</span></div>
      </div>
      <div class="its-service-card">
        <h3>Cross Browser Testing Automation</h3>
        <p>Run automated tests across Chrome, Firefox, Safari, and Edge simultaneously using Selenium Grid and
          BrowserStack.</p>
        <div class="its-tech-tags"><span>Selenium Grid</span><span>BrowserStack</span><span>Playwright</span></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="its-why-grid">
      <div class="its-why-card">
        ...
        <h4>Selenium</h4>
        <p>The most widely used open-source web automation framework — multi-browser, multi-language, with a massive
          ecosystem.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/cypress.svg" alt=""></div>
        <h4>Cypress</h4>
        <p>A modern JavaScript end-to-end testing framework built for the web with real-time reloads, time-travel
          debugging, and automatic waiting.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/playwright.svg" alt=""></div>
        <h4>Playwright</h4>
        <p>Microsoft's next-generation browser automation library — cross-browser, cross-platform, with built-in
          parallelism and trace viewer.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/jmeter.svg" alt=""></div>
        <h4>JMeter</h4>
        <p>Apache JMeter is the industry-standard load testing tool for measuring the performance and scalability of web
          applications.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/postman.svg" alt=""></div>
        <h4>Postman / Newman</h4>
        <p>API testing platform with powerful collection runner, Newman CLI, and CI/CD integrations for automated API
          testing at scale.</p>
      </div>
      <div class="its-why-card">
