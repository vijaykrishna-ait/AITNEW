...
<main id="main-content">
    ...
    <div class="wrap hero-grid">
      <div>
        ...
        <div class="hero-stats">
          <div class="stat" tabindex="0">
            <b>24-48 hrs</b><span>Qualified candidate <br>profiles delivered</span>
            <span class="stat-proof" role="note">Measured from requirement sign-off to the first shortlist being shared with your hiring manager.</span>
          </div>
          <div class="stat" tabindex="0">
            <b class="count-up" data-target="6" data-suffix=" Regions">6 Regions</b><span>Global talent reach <br> with local expertise</span>
            <span class="stat-proof" role="note">India, USA, Singapore, Dubai (MENA), Japan and Australia — see Global Reach below.</span>
          </div>
          <div class="stat" tabindex="0">
            <b class="count-up" data-target="40" data-suffix="% +">40% +</b><span>Reduction in hiring time <br>through smart sourcing</span>
            <span class="stat-proof" role="note">Compared against the client's own prior time-to-hire baseline before engaging us.</span>
          </div>
        </div>
      </div>
      <div class="hero-visual">
        ...
        <div class="floating-card fc-1">
          ...
          <div><b>24 hrs</b>
            <div class="sub">to first shortlist</div>
          </div>
        </div>
        <div class="floating-card fc-2">
          ...
          <div><b>500+ placements</b>
            <div class="sub">delivered to date</div>
          </div>
        </div>
      </div>
    </div>

      <?php /* REMOVED - trust strip: this was the third stats block in the
         first viewport (hero stats + floating cards + this), and its figures
         contradicted Why Us (24 vs 48 hrs). Why Us is now the single home
         for these numbers. Only '18 core technology practices' is not
         duplicated there. */ ?>
      <?php /*
    <!-- TRUST STRIP -->
    <div class="wrap">
      <div class="trust-strip">
        <div class="label">Why teams choose us</div>
        <ul>
          <li>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
              stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
            48 hrs average time to first match
          </li>
          <li>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            ...
            30–50% reduced time-to-hire
          </li>
          <li>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
              stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/></svg>
            500+ successful placements
          </li>
          <li>
            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
              stroke-linecap="round" stroke-linejoin="round"><path d="M12 2 4 5v6c0 5 3.5 9 8 11 4.5-2 8-6 8-11V5z"/><path d="m9 12 2 2 4-4"/></svg>
            18 core technology practices
          </li>
        </ul>
      </div>
    </div>
  ...
  <?php /* ORDER 2 of 9 - the core offer, moved up from below Tech Skills. */ ?>
  <!-- SOLUTIONS -->
  <section id="solutions">
    <div class="wrap">
      ...
      <div class="solutions-grid">
        <div class="sol-tabs" role="tablist" aria-label="Engagement models">
          <button type="button" class="sol-tab active" data-tab="talent" role="tab"
                  id="sol-tab-talent" aria-controls="sol-panel-talent" aria-selected="true" tabindex="0">Talent Solutions <span class="arrow" aria-hidden="true">→</span></button>
          <button type="button" class="sol-tab" data-tab="team" role="tab"
                  id="sol-tab-team" aria-controls="sol-panel-team" aria-selected="false" tabindex="-1">Team Solutions <span class="arrow" aria-hidden="true">→</span></button>
          <button type="button" class="sol-tab" data-tab="project" role="tab"
                  id="sol-tab-project" aria-controls="sol-panel-project" aria-selected="false" tabindex="-1">Project Solutions <span class="arrow" aria-hidden="true">→</span></button>
        </div>

        <div>
          <div class="sol-panel" data-panel="talent" data-title="Talent Solutions"
               id="sol-panel-talent" role="tabpanel" aria-labelledby="sol-tab-talent">
          ...
          <div class="sol-panel" data-panel="team" data-title="Team Solutions" style="display:none;"
               id="sol-panel-team" role="tabpanel" aria-labelledby="sol-tab-team">
            <div class="sol-panel-text">
            ...
            <div class="sol-panel-img">
              <img src="assets/images/index/team-solution.jpeg"
                width="626" height="352" loading="lazy" decoding="async"
                alt="Team collaborating around a table">
            </div>
          </div>

          <div class="sol-panel" data-panel="project" data-title="Project Solutions" style="display:none;"
               id="sol-panel-project" role="tabpanel" aria-labelledby="sol-tab-project">
            <div class="sol-panel-text">
            ...
            <div class="sol-panel-img">
              <img src="assets/images/index/project-solution.jpeg"
                width="626" height="384" loading="lazy" decoding="async"
  ...
  <?php /* ============================================================
     ORDER 3 of 9 - SOCIAL PROOF.
     The recommended structure puts client logos + a testimonial here.
     Neither exists yet: the logo wall below is placeholder brands
     (Google/Meta/J&J/Tata/Shell, each repeated twice) and there is no
     testimonial content anywhere in the repo. Publishing either as real
     would be a false claim, so this slot currently holds Why Us as the
     proof block. Restore the logo wall the moment three real, cleared
     client logos exist, and add a named testimonial beside it.
     ============================================================ */ ?>
  <!-- CLIENTS -->
  <?php /* Re-wrapped from an HTML comment into a PHP comment: as an HTML comment
     the placeholder logo wall was still being sent to every visitor (and its PHP
     still executed). Reasons for keeping it disabled are in the note above. */ ?>
  <?php /*
  ...
  */ ?>
  ...
  <!-- WHY US -->
  <section class="why">
    <div class="wrap why-grid" data-reveal="up">
      <div class="why-img">
      ...
      <div class="why-content">
        ...
        <div class="why-points">
          ...
          <div class="why-point"><b class="count-up" data-target="3">3</b><span>Global delivery hubs</span></div>
  ...
  <section class="steps" id="how-it-works">
    <div class="wrap">
      ...
      <div style="text-align:center;margin-top:48px;">
        <a href="<?= $base ?>contact" class="btn btn-primary btn-magnetic">Start the conversation →</a>
      </div>
    </div>
  </section>

  <?php /* ORDER 5 of 9 - moved down from slot 2. Best SEO asset on the page
     (18 internal links to hire-* pages), but it was appearing before the
     value proposition. */ ?>
  <!-- TECH SKILLS -->
  <section class="skills" id="skills">
    <div class="wrap">
      ...
      <div class="skill-filters" role="group" aria-label="Filter technologies by practice">
        <button type="button" class="skill-chip" data-cat="all" aria-pressed="true">All</button>
        <button type="button" class="skill-chip" data-cat="cloud" aria-pressed="false">Cloud &amp; DevOps</button>
        <button type="button" class="skill-chip" data-cat="frontend" aria-pressed="false">Frontend</button>
        <button type="button" class="skill-chip" data-cat="backend" aria-pressed="false">Backend</button>
        <button type="button" class="skill-chip" data-cat="mobile" aria-pressed="false">Mobile</button>
        <button type="button" class="skill-chip" data-cat="data" aria-pressed="false">Data &amp; AI</button>
        <button type="button" class="skill-chip" data-cat="enterprise" aria-pressed="false">Enterprise</button>
        <button type="button" class="skill-chip" data-cat="qa" aria-pressed="false">Quality</button>
      </div>

      <div class="skill-flat-grid" data-reveal="stagger">
        <a href="<?= $base ?>hire-cloud-engineer" class="skill-item" data-cat="cloud">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-devops-engineer" class="skill-item" data-cat="cloud">
          <div class="circle">
        ...
        <a href="<?= $base ?>sap-it-solutions" class="skill-item" data-cat="enterprise">
          <div class="circle">
        ...
        <a href="<?= $base ?>servicenow" class="skill-item" data-cat="enterprise">
        ...
        <a href="<?= $base ?>power-bi" class="skill-item" data-cat="data">
        ...
        <a href="<?= $base ?>aiml-solutions" class="skill-item" data-cat="data">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-data-engineer" class="skill-item" data-cat="data">
          <div class="circle"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M3 3v18h18" />
        ...
        <a href="<?= $base ?>hire-python-developer" class="skill-item" data-cat="backend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-react-developer" class="skill-item" data-cat="frontend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-angular-developer" class="skill-item" data-cat="frontend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-react-native-developer" class="skill-item" data-cat="mobile">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-vuejs-developer" class="skill-item" data-cat="frontend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-flutter-developer" class="skill-item" data-cat="mobile">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-java-developer" class="skill-item" data-cat="backend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-dotnet-developer" class="skill-item" data-cat="backend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-php-developer" class="skill-item" data-cat="backend">
          <div class="circle">
        ...
        <a href="<?= $base ?>hire-qa-developer" class="skill-item" data-cat="qa">
          <div class="circle"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <!-- <p class="skill-count" id="skillCount" role="status" aria-live="polite">Showing all 18 technologies</p> -->
    </div>
  </section>
  ...
  <section class="industries bg-white" id="industries">
    <div class="wrap">
      ...
      <div class="industries-layout">
        <div class="ind-list" role="tablist" aria-orientation="vertical" aria-label="Industries we serve">
          <button type="button" class="ind-row active" data-ind="0" role="tab"
                  aria-controls="ind-pane-0" aria-selected="true" tabindex="0">
            <span class="name"><span class="num">01</span>Banking &amp; Financial Services</span>
            <span class="arrow" aria-hidden="true">→</span>
          </button>
          <button type="button" class="ind-row" data-ind="1" role="tab"
                  aria-controls="ind-pane-1" aria-selected="false" tabindex="-1">
            <span class="name"><span class="num">02</span>Consumer Products</span>
            <span class="arrow" aria-hidden="true">→</span>
          </button>
          <button type="button" class="ind-row" data-ind="2" role="tab"
                  aria-controls="ind-pane-2" aria-selected="false" tabindex="-1">
            <span class="name"><span class="num">03</span>Healthcare &amp; Life Sciences</span>
            <span class="arrow" aria-hidden="true">→</span>
          </button>
          <button type="button" class="ind-row" data-ind="3" role="tab"
                  aria-controls="ind-pane-3" aria-selected="false" tabindex="-1">
            <span class="name"><span class="num">04</span>Hospitality</span>
            <span class="arrow" aria-hidden="true">→</span>
          </button>
          <button type="button" class="ind-row" data-ind="4" role="tab"
                  aria-controls="ind-pane-4" aria-selected="false" tabindex="-1">
            <span class="name"><span class="num">05</span>Manufacturing</span>
            <span class="arrow" aria-hidden="true">→</span>
          </button>
          <button type="button" class="ind-row" data-ind="5" role="tab"
                  aria-controls="ind-pane-5" aria-selected="false" tabindex="-1">
        ...
        <div class="ind-visual">
          ...
          <div class="pane" data-pane="2" id="ind-pane-2" role="tabpanel" data-title="Healthcare & Life Sciences">
            <img src="assets/images/index/healthcare.jpg"
              alt="Healthcare professionals in a hospital" loading="lazy" decoding="async">
            <div class="info">
  ...
  <section id="reach">
    <div class="wrap">
      <div class="reach-head" data-reveal="up">
        <h2>Global Reach,</h2>
        <div class="line"></div>
      </div>
      <div class="reach-grid" id="reachGrid" role="group" aria-label="Global delivery locations">
        <div class="reach-card">
          <img src="assets/images/index/india.jpeg"
            alt="Mumbai sea-link bridge at dusk, India" loading="lazy" decoding="async">
          <div class="label"><small>South Asia</small>India</div>
        </div>
        <div class="reach-card">
          <img src="assets/images/index/usa.jpeg"
            alt="City skyline at sunrise, USA" loading="lazy" decoding="async">
        ...
        <div class="reach-card">
          <img src="assets/images/index/singapore.jpeg"
            alt="Singapore skyline at dusk" loading="lazy" decoding="async">
          <div class="label"><small>Southeast Asia</small>Singapore</div>
        </div>
        <div class="reach-card">
          <img src="assets/images/index/dubai.jpeg"
            alt="Dubai skyline with skyscrapers, Middle East" loading="lazy" decoding="async">
          <div class="label"><small>MENA</small>Dubai</div>
        </div>
        <div class="reach-card">
          <img src="assets/images/index/japan.jpeg"
            alt="Tokyo skyline at night, Japan" loading="lazy" decoding="async">
          <div class="label"><small>East Asia</small>Japan</div>
        </div>
        <div class="reach-card">
          <img
            src="assets/images/index/australia.jpeg"
            alt="Sydney Opera House, Australia" loading="lazy" decoding="async">
          <div class="label"><small>Sydney</small>Australia</div>
        </div>
      </div>

      <div class="reach-controls">
        <button type="button" class="reach-arrow prev" aria-label="Scroll to previous locations">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"
            stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m15 18-6-6 6-6"/></svg>
        </button>
        <button type="button" class="reach-arrow next" aria-label="Scroll to next locations">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"
            stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="m9 18 6-6-6-6"/></svg>
        </button>
        <div class="reach-rail" aria-hidden="true"><span id="reachRail"></span></div>
      </div>
    </div>
  </section>

  <!-- CASE STUDIES (moved above the CTA — proof should precede the ask) -->
  <?php /* ============================================================
     COMMENTED OUT - CASE STUDIES teaser ("Proven results, real impact")
     VERIFY BEFORE RESTORING. Four results claims with hard numbers - "used across 200+ hospitals", "cutting manual processing time by over 60%", "30+ back-office workflows" - carrying no client name, no date and no engagement detail, illustrated with four hotlinked Unsplash stock photos. This is the same fabricated-proof pattern already pulled from this page (client logo wall, tech-experts marquee) and from leadership.php. All four cards link to case-studies.php, which repeats these four plus five more of the same kind, so nothing here is corroborated elsewhere in the repo.
     NOTE: the header/footer "Case Studies" links point at case-studies.php,
     not at this #case-studies anchor, so no navigation breaks.
  ...
  <section class="case-studies" id="case-studies">
    <div class="wrap">
      ...
      <div class="case-grid" data-reveal="stagger">
        <a href="<?= $base ?>case-studies" class="case-card">
          <div class="case-card-img">
            ...
            <img src="https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=700&q=80"
              alt="AI diagnostics in a hospital setting" loading="lazy" decoding="async">
          </div>
        ...
        <a href="<?= $base ?>case-studies" class="case-card">
          <div class="case-card-img">
            ...
            <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=700&q=80"
              alt="Automation workflow on screen" loading="lazy" decoding="async">
          </div>
          <div class="case-card-body">
        ...
        <a href="<?= $base ?>case-studies" class="case-card">
          <div class="case-card-img">
            ...
            <img src="https://images.unsplash.com/photo-1581093588401-fbb62a02f120?auto=format&fit=crop&w=700&q=80"
              alt="Sales team reviewing CRM dashboard" loading="lazy" decoding="async">
          </div>
          <div class="case-card-body">
        ...
        <a href="<?= $base ?>case-studies" class="case-card">
          <div class="case-card-img">
            ...
            <img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=700&q=80"
              alt="Student learning online with laptop" loading="lazy" decoding="async">
          </div>
          <div class="case-card-body">
  ...
  */ ?>
  ...
  <section class="cta" id="contact">
    ...
    <form class="cta-form" id="ctaLeadForm" action="<?= $base ?>send-mail.php" method="post" novalidate>
      <div class="field-row">
        <label class="visually-hidden" for="ctaEmail">Work email</label>
        <input type="email" id="ctaEmail" name="email" required
               autocomplete="email" placeholder="Your work email">
        <button type="submit" class="btn btn-lime btn-magnetic">Talk to an Expert</button>
      </div>

      <div class="cta-more">
        <div class="field-row">
          <label class="visually-hidden" for="ctaFirstName">First name</label>
          <input type="text" id="ctaFirstName" name="firstName" required
                 autocomplete="given-name" placeholder="First name">
          <label class="visually-hidden" for="ctaLastName">Last name</label>
          <input type="text" id="ctaLastName" name="lastName" required
                 autocomplete="family-name" placeholder="Last name">
        </div>
        <label class="visually-hidden" for="ctaPhone">Phone (optional)</label>
        <input type="tel" id="ctaPhone" name="phone" autocomplete="tel" placeholder="Phone (optional)">

        <label class="visually-hidden" for="ctaSubject">What do you need?</label>
        <select id="ctaSubject" name="subject" required>
          <option value="">What do you need?</option>
          <option value="Talent Solutions">Hire individual specialists</option>
          <option value="Team Solutions">Build a dedicated team</option>
          <option value="Project Solutions">Deliver a full project</option>
          <option value="Consulting">Technology consulting</option>
          <option value="Careers">I'm looking for a role</option>
        </select>

        <label class="visually-hidden" for="ctaMessage">Brief requirement</label>
        <textarea id="ctaMessage" name="message" rows="3" required
                  placeholder="Roles, skills, timeline or anything else that helps us respond well"></textarea>
      </div>
      ...
      <p class="cta-hint">
        ...
        We typically reply within one business day. Prefer to talk? Call <?= SITE_PHONE_DISPLAY ?>.
      </p>

      <div class="cta-response" id="ctaResponse" role="status" aria-live="polite"></div>
    </form>

    <div class="actions" style="margin-top:26px;">
      <a href="<?= $base ?>contact" class="btn btn-outline-light">Full contact form</a>
      <a href="<?= $base ?>career#open-positions" class="btn btn-outline-light">View Open Roles</a>
    </div>
  </section>

  <?php /* ############################################################
     SECTIONS REMOVED FROM THE HOMEPAGE
     Kept here verbatim so nothing is lost. Each block is wrapped in a PHP
     comment, so it is not sent to the browser at all.
     ############################################################ */ ?>

  <?php /* ============================================================
     REMOVED FROM HOMEPAGE - SERVICES tabs (Enterprise / Digital / Consulting)
     Duplicated the Solutions tabs directly above it - two tabbed "what we do" widgets back to back. Its "Resource Augmentation" card IS Talent Solutions, and its SAP / ServiceNow / Power BI / Cloud / AI cards repeat tiles already in Tech Skills. NOTE: header.php still links "What We Do" to #services, which no longer exists on this page - repoint it to #solutions.
     Markup kept verbatim. To restore: delete the PHP comment wrapper
     around this block and move it back into the page order above.
     ============================================================ */ ?>
  <?php /*
  <!-- SERVICES -->
  ...
  <div class="wrap">
    ...
    <div class="svc-tabs" role="tablist" aria-label="Service categories">
      <button type="button" class="svc-tab active" data-svc="enterprise" role="tab"
              id="svc-tab-enterprise" aria-controls="svc-panel-enterprise" aria-selected="true" tabindex="0">
        <div class="ico" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
            stroke-linecap="round" stroke-linejoin="round">
            <rect x="3" y="3" width="7" height="18" rx="1.5"/><rect x="14" y="3" width="7" height="9" rx="1.5"/>
            <path d="M14 16h7M14 20h7"/>
          </svg>
        </div>
        <b>Enterprise Solutions</b>
      </button>

      <button type="button" class="svc-tab" data-svc="digital" role="tab"
              id="svc-tab-digital" aria-controls="svc-panel-digital" aria-selected="false" tabindex="-1">
        <div class="ico" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
            stroke-linecap="round" stroke-linejoin="round">
            <path d="M17.5 19a4.5 4.5 0 0 0 .5-8.97A6 6 0 0 0 6.2 9.2 4.5 4.5 0 0 0 6.5 19z"/>
            <path d="M12 12v6"/><path d="m9.5 15.5 2.5-3 2.5 3"/>
          </svg>
        </div>
        <b>Digital Transformation</b>
      </button>

      <button type="button" class="svc-tab" data-svc="consulting" role="tab"
              id="svc-tab-consulting" aria-controls="svc-panel-consulting" aria-selected="false" tabindex="-1">
        <div class="ico" aria-hidden="true">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"
            stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 20v-3a4 4 0 0 1 4-4h2"/><circle cx="8" cy="7" r="3"/>
            <path d="M13 20v-2a3 3 0 0 1 3-3h1a3 3 0 0 1 3 3v2"/><circle cx="16.5" cy="9.5" r="2.5"/>
          </svg>
        </div>
    ...
    <div class="svc-panels" data-title="Enterprise Solutions" data-svcpanel="enterprise"
         id="svc-panel-enterprise" role="tabpanel" aria-labelledby="svc-tab-enterprise">
      <a href="<?= $base ?>hire-veeva-developer" class="svc-card">
        ...
        <span class="svc-card-arrow">Explore <span aria-hidden="true">→</span></span>
      </a>

      <a href="<?= $base ?>enterprise-solutions" class="svc-card">
      ...
      <a href="<?= $base ?>servicenow" class="svc-card">
    ...
    <div class="svc-panels" data-svcpanel="digital" data-title="Digital Transformation" style="display:none;"
         id="svc-panel-digital" role="tabpanel" aria-labelledby="svc-tab-digital">
      <a href="<?= $base ?>cloud-engineering" class="svc-card">
      ...
      <a href="<?= $base ?>power-bi" class="svc-card">
    ...
    <div class="svc-panels" data-svcpanel="consulting" data-title="Consulting Services" style="display:none;"
         id="svc-panel-consulting" role="tabpanel" aria-labelledby="svc-tab-consulting">
      <a href="<?= $base ?>it-consulting" class="svc-card">
      ...
      <a href="<?= $base ?>it-staffing" class="svc-card">
      ...
      <a href="<?= $base ?>application-solutions" class="svc-card">
  ...
  */ ?>
  ...
  <?php /* ============================================================
     REMOVED FROM HOMEPAGE - TECH EXPERTS marquee
     Six Unsplash stock photos labelled with specific full names and years of experience, presented as staff. For a company whose product is people, fabricated people is the worst credibility failure available. Restore only with real photos and real names (see leadership.php).
     Markup kept verbatim. To restore: delete the PHP comment wrapper
     around this block and move it back into the page order above.
     ============================================================ */ ?>
  <?php /*
  ...
  <section class="experts">
    <div class="wrap">
      ...
      <div class="marquee-toggle-wrap">
        <button type="button" class="marquee-toggle" id="marqueeToggle" aria-pressed="false">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>
          </svg>
          <span class="marquee-toggle-text">Pause</span>
          <span class="visually-hidden"> the scrolling expert profiles</span>
        </button>
      </div>
    </div>
    <div class="experts-viewport">
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80"
          alt="Prem Kumar" loading="lazy" decoding="async">
        <div class="info">
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1500648767791-00d5a4ee9baa?auto=format&fit=crop&w=500&q=80"
          alt="Dhinesh Kumar" loading="lazy" decoding="async">
        <div class="info">
          <span class="exp">15+ yrs</span>
          <h3>Dhinesh Kumar</h3>
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=500&q=80"
          alt="Arjun Mehta" loading="lazy" decoding="async">
        <div class="info">
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=500&q=80"
          alt="Sarah Lin" loading="lazy" decoding="async">
        <div class="info">
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=500&q=80"
          alt="Rajesh Iyer" loading="lazy" decoding="async">
        <div class="info">
      ...
      <div class="expert-card">
        <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&w=500&q=80"
          alt="Fatima Al Sayed" loading="lazy" decoding="async">
        <div class="info">
      ...
      <div class="expert-card" aria-hidden="true">
        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=500&q=80"
          alt="Prem Kumar" loading="lazy" decoding="async">
        <div class="info">
          <span class="exp">15+ yrs</span>
    ...
    </div><!-- /.experts-viewport -->
  </section>
  */ ?>

  <?php /* ============================================================
     REMOVED FROM HOMEPAGE - HIRE TALENT SPLIT (For Employers)
     Two paragraphs restating the hero, with CTAs pointing back to sections the reader has already scrolled past.
     Markup kept verbatim. To restore: delete the PHP comment wrapper
     around this block and move it back into the page order above.
     ============================================================ */ ?>
  <?php /*
  <!-- HIRE TALENT SPLIT -->
  <section>
    <div class="wrap split" data-reveal="up">
      <div class="split-img">
        <img src="assets/images/index/hr.jpeg"
          width="626" height="626" loading="lazy" decoding="async"
      ...
      <div>
        ...
        <div class="split-actions">
          <a href="<?= $base ?>contact" class="btn btn-primary btn-magnetic">Start Hiring →</a>
          <a href="<?= $base ?>#how-it-works" class="btn btn-outline">See How It Works</a>
        </div>
      </div>
    </div>
  </section>
  */ ?>
  ...
  <?php /* ============================================================
     REMOVED FROM HOMEPAGE - FEATURED JOBS
     Candidate content inside an employer funnel; six hand-coded listings already 6-10 weeks stale (dated 12-28 Jun 2026); all six "Learn More" buttons resolve to the same career#open-positions anchor. Belongs on career.php, driven by data.
     Markup kept verbatim. To restore: delete the PHP comment wrapper
     around this block and move it back into the page order above.
     ============================================================ */ ?>
  <?php /*
 ...
 <section class="jobs" id="jobs">
    <div class="wrap">
        ...
        <div class="jobs-carousel">
            <button type="button" class="jobs-arrow prev" aria-label="Previous jobs" aria-controls="jobsSlider">
                <span aria-hidden="true">&#10094;</span>
            </button>
            <div class="jobs-slider" id="jobsSlider" tabindex="0" role="group"
                 aria-label="Featured job openings — scrollable, use arrow keys">
                <div class="job-card">
                    <div>
            ...
            <button type="button" class="jobs-arrow next" aria-label="Next jobs" aria-controls="jobsSlider">
                <span aria-hidden="true">&#10095;</span>
            </button>
        </div>

        <div class="jobs-dots" id="jobsDots" role="group" aria-label="Job carousel pages"></div>

        <div style="text-align:center;margin-top:30px;">
            <a href="<?= $base ?>career#open-positions" class="btn btn-outline-light">View all open roles →</a>
        </div>
    </div>
</section>
  */ ?>
  ...
  <?php /* ============================================================
     REMOVED FROM HOMEPAGE - NEWS / BLOG
     Was already commented out before this change; moved here to keep the live page readable. news-blog.php covers this.
     Markup kept verbatim. To restore: delete the PHP comment wrapper
     around this block and move it back into the page order above.
     ============================================================ */ ?>
  <?php /*
...
<?php /* REMOVED - sticky CTA bar: the page already carries a floating contact
   button and ends in a CTA form. Three persistent overlays at once is heavy
   on mobile. home.js null-checks #stickyCta. */ ?>
<?php /*
<!-- STICKY CTA -->
<div class="sticky-cta" id="stickyCta">
  <div class="sticky-cta-inner">
    <div class="text">
      <b>Need talent on your team?</b>
      <span>Qualified profiles in 24–48 hours across 6 global locations.</span>
    </div>
    <div class="actions">
      <a href="<?= $base ?>#contact" class="btn btn-lime">Talk to an Expert</a>
      <a href="tel:<?= SITE_PHONE_TEL ?>" class="btn btn-outline-light"><?= SITE_PHONE_DISPLAY ?></a>
      <button type="button" class="sticky-cta-close" aria-label="Dismiss this bar">
...
<div class="float-contact" id="floatContact">
  ...
  <div class="float-actions">
    ...
    <a class="float-action" href="<?= $base ?>#contact">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M9 15h6"/></svg>
      Send a brief
    </a>
  </div>
</div>
