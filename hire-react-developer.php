...
<section class="solutions" id="services">
  <div class="wrap">
    <div class="section-head">
      ...
      <h2>Our React JS Development Services</h2>
    </div>
    <div class="its-services-grid">
      <div class="its-service-card">
        <h3>Component Architecture</h3>
        <p>Build modular, reusable UI components using React's component-based architecture for maintainable and scalable applications.</p>
        <div class="its-tech-tags"><span>React 18</span><span>JSX</span><span>Hooks</span></div>
      </div>
      <div class="its-service-card">
        <h3>Redux State Management</h3>
        <p>Implement predictable, centralized state management with Redux and Redux Toolkit for complex application state.</p>
        <div class="its-tech-tags"><span>Redux</span><span>RTK</span><span>Thunk</span></div>
      </div>
      <div class="its-service-card">
        <h3>Next.js Development</h3>
        <p>Server-side rendered and statically generated React applications with Next.js for optimum SEO and performance.</p>
        <div class="its-tech-tags"><span>Next.js</span><span>SSR</span><span>SSG</span></div>
      </div>
      <div class="its-service-card">
        <h3>GraphQL Integration</h3>
        <p>Connect React applications to GraphQL APIs using Apollo Client for efficient, type-safe data fetching.</p>
        <div class="its-tech-tags"><span>Apollo</span><span>GraphQL</span><span>REST</span></div>
      </div>
      <div class="its-service-card">
        <h3>React Native Development</h3>
        <p>Extend your React codebase to mobile platforms with React Native — one team, cross-platform expertise.</p>
        <div class="its-tech-tags"><span>React Native</span><span>Expo</span><span>iOS/Android</span></div>
      </div>
      <div class="its-service-card">
        <h3>Testing & Quality Assurance</h3>
        <p>Comprehensive React testing strategies using Jest, React Testing Library, and Cypress for rock-solid reliability.</p>
        <div class="its-tech-tags"><span>Jest</span><span>RTL</span><span>Cypress</span></div>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="its-why-grid">
      <div class="its-why-card">
        ...
        <h4>Redux</h4>
        <p>A predictable state container for JavaScript apps. Redux makes the state of your application transparent and manageable.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/nextjs.svg" alt=""></div>
        <h4>Next.js</h4>
        <p>A React framework that enables server-side rendering and static site generation for production-ready web applications.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/graphql.svg" alt=""></div>
        <h4>GraphQL</h4>
        <p>A query language for APIs that gives clients the power to ask for exactly the data they need — no more, no less.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/vite.svg" alt=""></div>
        <h4>Vite</h4>
        <p>A blazing-fast build tool and development server that dramatically improves React developer experience and build performance.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/typescript.svg" alt=""></div>
        <h4>TypeScript</h4>
        <p>Typed superset of JavaScript that catches bugs early and makes large React codebases far more maintainable.</p>
      </div>
      <div class="its-why-card">
        <div class="its-why-num"><img src="assets/logos/tailwindcss.svg" alt=""></div>
        <h4>Tailwind CSS</h4>
        <p>Utility-first CSS framework that integrates perfectly with React for rapid, custom UI development without leaving your components.</p>
      </div>
    </div>
  </div>
</section>
